...
const modelsInfo = {
  ...
  User: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "emailVerified", "image", "createdAt", "updatedAt", "roles"],
...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "accounts", "sessions", "roles"],
  UserOrderByInput: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles"],
  UserWhereUniqueInput: ["id", "email"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles"],
  ...
  UserCreateInput: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles", "accounts", "sessions"],
  UserUpdateInput: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles", "accounts", "sessions"],
  UserCreateManyInput: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles"],
  UserUpdateManyMutationInput: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles"],
  ...
  UserCreateWithoutAccountsInput: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles", "sessions"],
  UserCreateOrConnectWithoutAccountsInput: ["where", "create"],
  UserUpsertWithoutAccountsInput: ["update", "create"],
  UserUpdateWithoutAccountsInput: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles", "sessions"],
  UserCreateWithoutSessionsInput: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles", "accounts"],
  UserCreateOrConnectWithoutSessionsInput: ["where", "create"],
  UserUpsertWithoutSessionsInput: ["update", "create"],
  UserUpdateWithoutSessionsInput: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles", "accounts"],
...
const outputsInfo = {
  ...
  UserGroupBy: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles", "_count", "_min", "_max"],
  ...
  UserCountAggregate: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt", "roles", "_all"],
  UserMinAggregate: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt"],
  UserMaxAggregate: ["id", "firstName", "lastName", "name", "email", "emailVerificationToken", "password", "emailVerified", "image", "createdAt", "updatedAt"],
